...
export default function Helpdesk() {
  return (
    <div
      className="text-center bg-linear-to-r from-cyan-100 via-blue-300 to-blue-400 rounded-xl mt-16 max-w-7xl m-5  md:mx-auto mb-10"
    >
      <div className=" rounded-xl p-8 lg:p-12 shadow-xl ">
        <h1 className={`text-3xl lg:text-4xl font-bold mb-4   text-black`}>
          Ready to Transform Your Idea?
        </h1>
        <p className="md:text-lg text-md text-justify md:text-center opacity-90 mb-8 max-w-2xl mx-auto text-black">
